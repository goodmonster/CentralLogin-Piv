        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="homeHeader corrected text-left">
                    VA Access Control Services</span>
                </div>
                <div>
                    ...
                    <div class="hometext corrected text-left">
                        <script type="text/javascript">
                            document.write("Please check your User ID and Password and <a href='" + "https://mvitkssoi-prod.aac.va.gov/imdquiWeb/login.do'>try to login again</a>.");
                        </script>
                        <br />
